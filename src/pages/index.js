      ...
      <div className='pt-0 md:pt-20'>
        <div className='px-5 md:px-20 z-10'>
          ...
          <div className='text-center z-10 relative'>
            ...
            <div className='flex flex-wrap-reverse items-center mb-16 md:mb-0'>
              <div className='w-full md:w-5/12 text-left pr-16'>
                <div className='font-bold text-3xl text-qritile-600 mb-6'>{selectedFeature.title}</div>
                <div className='text-lg md:text-xl font-light mb-7'>{selectedFeature.description}</div>
          ...
          <div className='px-5 md:px-20 relative '>
            <div className='text-right'>
              <div className='inline-block mb-6'>
                <div className='text-qripink-600 text-4xl md:text-5xl font-black mb-7'>Featured Datasets</div>
                <SearchInput />
              </div>
            </div>
            <div className='flex'>
        ...
        <div className='py-48 relative'>
          ...
          <div className='px-5 md:px-20 relative flex '>
        ...
        <div className='relative'>
          ...
          <div className='px-5 md:px-20 relative w-full'>
