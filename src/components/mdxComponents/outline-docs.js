...
export default {
  ...
  h2: props => <h2 className='text-qrigray-900 font-semibold tracking-wide mt-12 mb-6 text-2xl' {...props} />,
  h3: props => <h3 className='text-qrigray-800 font-semibold mt-12 mb-6 text-xl' {...props} />,
  h4: props => <h4 className='text-qrigray-700 font-medium mt-12 mb-6 text-lg' {...props} />,
  h5: props => <h5 className='text-qrigray-600 font-medium mb-1' {...props} />,
