  ...
  <section id="download_app" class="rotate">
    <div class="wrap unrotate">
      <div class="text_block">
        ...
        <br />
        <a href="https://github.com/qri-io/frontend/releases/download/v0.6.1/qri-0.6.1.dmg" download="qri.dmg" class="download button">
  ...
  <section id="download_cli">
    <div class="wrap">
      <div class="text_block">
        ...
        <a href="https://github.com/qri-io/qri/releases/download/v0.6.1/qri_os_x_cli_darwin_amd64.pkg" download="qri_cli.pkg" class="download button">
